...
class AudiosControllerTest < ActionController::TestCase
  ...
  test "should create audio" do
    assert_difference('Audio.count') do
      post :create, audio: { album_id: @audio.album_id, artist: @audio.artist, audio: @audio.audio, title: @audio.title }
    end
  ...
  test "should update audio" do
    patch :update, id: @audio, audio: { album_id: @audio.album_id, artist: @audio.artist, audio: @audio.audio, title: @audio.title }
    assert_redirected_to audio_path(assigns(:audio))
  end
